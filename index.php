...
<html><head>
    ...
    <base href="http://localhost/pyexs/">
	<link rel="icon" href="gambar/admin/logo.png">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i class="fa fa-stethoscope" aria-hidden="true"></i>PX</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="fa fa-stethoscope" aria-hidden="true"></i>Pyexs</b></span>
        </a>
        <!-- Header Navbar -->
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="max-width: 450px;">
            ...
            <div class="modal-body">
                ...
                <form role="form"> 
                <div>
                      <p> <img src="aset/banner/lmao.png" ALIGN = "center" > </p>
                      <p> Silahkan Scan QR Code diatas ini.</p>
                      <p> Atau Klik <a href="https://api.whatsapp.com/send?phone=6281366813996" target="_blank"> Link ini.<a> </p>
                    </div>
                </form>
            </div>
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Copyright © 2022 - by <a href="https://www.linkedin.com/in/topazmulia" target="_blank">Topaz Mulia Abadi</a></div></strong>
      </footer>
