...
<head>
  ...
  <body>
<div class="ayaem" src="aset/login/ayaem-login.png">
<img src ="aset/login/ayaem-login.png">
  <div class="hand">
...
<input type="submit" name="submit" id="submitku" value="   Login   " /><br>
 <p class="message">Ingin mendaftar? <a href="https://forms.gle/VHQSDvmXZbjPZHnv9" target="_blank">Ajukan Permohonan</a></p>
  </form>
</div>
</body>
