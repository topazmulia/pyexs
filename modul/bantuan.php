...
<div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="tab-pane" id="tab_1"><div style="text-align: center;"><br><br><br><br><br><br>
				...
				Silahkan hubungi admin dengan mengklik tombol kontak admin. Jika butuh bantuan silahkan kirim pesan WhatsApp tentang apa yang menjadi kendala.<br><br>
              ...
              <div class="box-group" id="accordion">
                ...
                <div class="panel box box-danger">
                  ...
                  <div id="collapseTwo" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="box-body">
                     	<a href="animasi/bantuan/user/diagnosa.gif" target="_blank"><img src="animasi/bantuan/user/diagnosa.gif" alt="Mengakses Diagnosa" /></a><br><br>
                     <div style="font-size: 16px;">
					 1. Langkah pertama adalah mengarahkan kursor atau tangan ke bagian menu diagnosa<br>
					 2. Selanjutnya silahkan cari gejala yang di dapati di halaman.<br>
				...
				<div class="panel box box-primary">
                  ...
                  <div id="collapseFour" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="box-body">
					<a href="animasi/bantuan/user/keterangan.gif" target="_blank"><img src="animasi/bantuan/user/keterangan.gif" alt="Mengakses Menu" /></a><br><br>
                     <div style="font-size: 16px;">
