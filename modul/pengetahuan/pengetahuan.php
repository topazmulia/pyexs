...
switch($_GET[act]){
  ...
  case "tambahpengetahuan":
	echo "	<div class='alert alert-success alert-dismissible'>
				...
				<b>Contoh:</b><br>
				Jika kepercayaan <b>(MB)</b> anda terhadap gejala Gusi mudah berdarah untuk penyakit Gingivitis Akut adalah <b>0.6 (Kemungkinan Besar)</b><br>
				Dan ketidakpercayaan <b>(MD)</b> anda terhadap gejala Gusi mudah berdarah untuk penyakit Gingivitis Akut adalah <b>0.2 (Hampir Mungkin)</b><br><br>
				<b>Maka:</b> CF(Pakar) = MB – MD (0.6 - 0.2) = <b>0.4</b> <br>
				Dimana nilai kepastian anda terhadap gejala Gusi mudah berdarah untuk penyakit Gingivitis Akut adalah <b>0.4 (Mungkin)</b>
              </div>
